...
MS_COMMAND = "./ms 2 100 -t 30000 -r 6000 30000000 -eN 0.01 10"

# Path to the output file comming from the PSMC
PSMC_RESULTS_M1 = "./dem_history_nIslands_n10_M10_2islands.psmc"
#PSMC_RESULTS_M10 = "./dem_history_nIslands_n10_M10.psmc"
...
if __name__ == "__main__":
    ...
    if PLOT_PSMC_RESULTS:
        (estimated_times, estimated_sizes) = psmc2fun(PSMC_RESULTS_M1, BIN_SIZE, MUTATION_RATE)    
        print(estimated_times, estimated_sizes)
        ax.step(estimated_times, estimated_sizes, where='post', linestyle='--', color='b', label = "PSMC estimated history M=1")
        #(estimated_times, estimated_sizes) = psmc2fun(PSMC_RESULTS_M10, BIN_SIZE, MUTATION_RATE)    
        #print(estimated_times, estimated_sizes)
        #ax.step(estimated_times, estimated_sizes, where='post', linestyle='--', color='r', label = "PSMC estimated history M=10")
